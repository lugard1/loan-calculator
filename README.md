...
## Learning Objectives
- Understand how to replicate a cool Loan Calculator application which can be adapted for different applications for good calculation of loans and knowledge of amount payable at a given number of months depending on loan amount and the interest rate which enhances user experience, and supports beautiful user interfaces.

## Description of the Project
For the first milestone in the process of creating Loan calculator application, you will:
